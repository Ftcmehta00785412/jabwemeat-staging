...
export const PRODUCTS: Product[] = [
  ...
  { id:'p3', sku:'JWM-MUT-001', name:'Premium Mutton Chops', category:'Mutton', description:'Meaty bone-in chops selected for grills and rich home-style curries.', weight:'500 g', servings:'3–4', price:449, mrp:499, stock:9, icon:'🍖', featured:true },
  { id:'p4', sku:'JWM-FSH-001', name:'Fresh Whole Rohu', category:'Fish & Seafood', description:'Fresh Rohu shown whole; cut and cleaning options will be added with live SKUs.', weight:'Approx. 1 kg', servings:'4–5', price:199, mrp:229, stock:14, icon:'🐟' },
  { id:'p5', sku:'JWM-SEA-001', name:'Whole Freshwater Prawns', category:'Fish & Seafood', description:'Fresh whole prawns suitable for curries, fries and quick starters.', weight:'250 g', servings:'2', price:249, mrp:289, stock:6, icon:'🦐' },
